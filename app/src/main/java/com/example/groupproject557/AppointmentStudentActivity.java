...
public class AppointmentStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        FloatingActionButton fabSortnew = findViewById(R.id.fabtnsortNew);
        FloatingActionButton fabSortApprove = findViewById(R.id.fabtnsorApprove);
        FloatingActionButton fabSortDecline = findViewById(R.id.fabtnsorDecline);
    ...
    private void updateListViebyStatus(String temp) {
        ...
        appointmentService.getAllAppointmentbyIDNStatus(user.getToken() , user.getId(),temp).enqueue(new Callback<List<Appointment>>() {
            @Override
