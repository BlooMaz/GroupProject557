...
public interface AppointmentService {
    ...
    @GET("api/Appointment")
    Call<List<Appointment>> getAllAppointmentbyIDNStatus(@Header("api-key") String api_key, @Query("student_id") int student_id , @Query("status") String status);

    @GET("api/Appointment")
    Call<List<Appointment>> getAllAppointmentReqbyID(@Header("api-key") String api_key, @Query("lecturer_id") int lecturer_id);

    @GET("api/Appointment")
    Call<List<Appointment>> getAllAppointmentReqbyIDNStatus(@Header("api-key") String api_key, @Query("lecturer_id") int lecturer_id , @Query("status") String status);
