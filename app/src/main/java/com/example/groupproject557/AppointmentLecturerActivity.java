...
public class AppointmentLecturerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fabSortApprove = findViewById(R.id.fabtnsorApprove1);
        FloatingActionButton fabSortDecline = findViewById(R.id.fabtnsorDecline1);
        FloatingActionButton fabSortnew = findViewById(R.id.fabtnsortNew1);

        fabSortnew.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view)
            {   String temp = "New";
                updateListViebyStatus(temp);
            }        });

        fabSortApprove.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view)
            {String temp = "Approve";
                updateListViebyStatus(temp);
        ...
        fabSortDecline.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view)
            {String temp = "Decline";
                updateListViebyStatus(temp);
    ...
    private void updateListViebyStatus(String temp) {
        ...
        appointmentService.getAllAppointmentReqbyIDNStatus(user.getToken() , user.getId(),temp).enqueue(new Callback<List<Appointment>>() {
            @Override
